...
def main(width=960, height=512):
    ...
    divide_two.save(f"{CACHE_DIR}/output/01_attention_couple_div2.jpg", quality=92)
   ...
   # all left middle right
    ...
    divide_three.save(f"{CACHE_DIR}/output/01_attention_couple_div3.jpg", quality=92)
    ...
    fig.savefig(f"{CACHE_DIR}/output/01_attention_couple_compare.png")
...
if __name__ == "__main__":
    ...
    subprocess.run(
        f'modal nfs get model-cache-vol output/01_attention_couple* .', shell=True)
