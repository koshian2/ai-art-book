...
def main():
    ...
    fig.savefig(f"{CACHE_DIR}/output/06_controlnet_with_adain_texture.png")

if __name__ == "__main__":
    with stub.run():
        main.call()
    subprocess.run(
        f'modal nfs get model-cache-vol output/06_controlnet_with_adain_texture.png output', shell=True)
